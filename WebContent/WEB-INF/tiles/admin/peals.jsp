		...
		var table = $("#towertable").DataTable({
			...
			"columnDefs": [ {
			      ...
			      "render": function ( data, type, full, meta ) {
			          return '<a class="btn btn-xs btn-primary" href="${pageContext.request.contextPath}/admin/peals/edit?p='+data +'">Edit</a> <a class="btn btn-xs btn-danger" href="${pageContext.request.contextPath}/admin/peals/dodelete?p='+data +'">X</a>';
			        }
			    } ]
		});
