...
public class TowerCaptainController {
	...
	public String captainViewTower(Model model, Principal principal, RedirectAttributes redirectAttributes) {
	...
	public String doEdit(Model model, TowerWrapper towerWrapper,
		...
		if (result.hasErrors()) {
			redirectAttributes.addFlashAttribute("dangerMessage", "An unexpected validation error occured and the tower could not be edited.");
	 ...
	 * @return redirect:/captain/towers/towers view if successful
	 */
	...
	public String doAddPractice(Model model, @Valid Practice practice,
		...
		if (result.hasErrors()) {
			model.addAttribute("practice", practice);
			redirectAttributes.addFlashAttribute("dangerMessage", "There was an issue validating the input. Make sure no fields were left blank and the help below was followed.");
	...
	public String doDeletePractice(Model model, @RequestParam("pr") int pr, Principal principal, RedirectAttributes redirectAttributes) {
	...
	public String doDeleteContact(Model model, @RequestParam("c") int c, RedirectAttributes redirectAttributes, Principal principal) {
