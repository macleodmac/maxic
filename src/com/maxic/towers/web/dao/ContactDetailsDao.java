...
public class ContactDetailsDao {
	...
	public List<ContactDetails> getContactDetails() {
		...
		return jdbc.query("SELECT * FROM ContactDetails", new RowMapper<ContactDetails>() { //not sure

			public ContactDetails mapRow(ResultSet rs, int rowNum) throws SQLException {
				ContactDetails ContactDetails = new ContactDetails(rs.getInt("towerId"), rs
						.getString("email"), rs.getString("contactNumber"), rs
						.getString("website"), rs.getString("facebookPage"), rs
	...
	public ContactDetails getContactDetails(int id) {
		...
		return jdbc.queryForObject("SELECT * FROM ContactDetails where towerId = :id",
				params, new RowMapper<ContactDetails>() {

					public ContactDetails mapRow(ResultSet rs, int rowNum)
							throws SQLException {
						ContactDetails ContactDetails = new ContactDetails(rs.getInt("towerId"), rs
								.getString("email"), rs.getString("contactNumber"),
								rs.getString("website"), rs
	...
	public boolean addContactDetails(ContactDetails ContactDetails) {
		System.out.println("Adding ContactDetails " + ContactDetails.getTowerId());
		BeanPropertySqlParameterSource params = new BeanPropertySqlParameterSource(
				ContactDetails);
		boolean test = jdbc
				.update("INSERT INTO ContactDetails (`email`, `contactNumber`, `website`,"
