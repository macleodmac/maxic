...
public class PealDao {
	...
	rs.getString("deadLication"),rs.getString("dateRung"),rs.getString("time"),
	rs.getString("tenor"),rs.getString("method"),rs.getString("methodDetails"),
	rs.getInt("changes"),rs.getString("leader"),rs.getString("composer"),
	rs.getString("footnotes"),rs.getString("composition"));
	...
	public boolean addPeal(Peal peal){
		...
		BeanPropertySqlParameterSource params = new BeanPropertySqlParameterSource(
				peal);
		boolean test = jdbc.update("INSERT INTO peals (`pealId`,`deadlication`,"
				+ "`dateRung`,`time`,`tenor`,`method`,`methodDetails`,`changes`,"
				+ "`leader`,`composer`,`footnotes`,`composition`)"
				+ "VALUES (:pealId, :deadlication, "
				+ ":dateRung, :time, :tenor, :method, :methodDetails, :changes, "
				+ ":leader, :composer, :footnotes, :composition)",
				params) == 1;
		return test;
	...
	public boolean editPeal(Peal peal){
		...
		boolean test = jdbc.update("UPDATE peals SET pealId = :pealId, "
				+ "deadlication = :deadlication, "
				+ "dateRung = :dateRung,"+"time = :time,"+"tenor = :tenor,"
